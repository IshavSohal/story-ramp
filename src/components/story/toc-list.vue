<template>
    <ul
        ...
        :class="{
            'nav-content menu': tocType === 'vertical',
            'dropdown-nav-content bg-white pb-10 w-72 z-10 border-r border-gray-200': tocType === 'mobile'
        }"
    >
            ...
            >
                ...
                >
                    ...
                    >
                        <svg
                            ...
                            viewBox="0 0 24 24"
                            width="18"
                            :class="{ 'rotate-180': tocType !== 'horizontal' || sublistToggled === idx }"
                            v-if="tocType === 'horizontal' || isSublistToggled(idx)"
                        >
                ...
                <ul v-show="isSublistToggled(idx)" class="sublist-menu">
                    <li
                        ...
                        :key="subIdx"
                        :class="{
                            'border-t-2 border-gray-300': tocType === 'horizontal' && subIdx !== 0,
...
const toggleSublist = (index: number): void => {
    if (props.tocType === 'horizontal') {
        sublistToggledHorizontal.value = sublistToggled.value !== index ? index : -1;
    } else {
